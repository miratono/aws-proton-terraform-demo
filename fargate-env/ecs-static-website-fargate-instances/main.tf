...
To manage this resource, see AWS Proton Resource: arn:aws:proton:ap-northeast-1:529160314193:service/ecs-static-website/service-instance/fargate-instances
